// generated by PharoJS *** DO NOT EDIT *** on 2022-02-02T22:41:53.139425+01:00 by noury
'use strict';
...
i$(function pj_identityHash(){return 957606400});
...
Object.pj_subclass_("WcComponentFactory");
WcComponentFactory.$$def(function(i$,c$,cp$){
i$(function pj_build(){this.pj_generateDomClass();this.pj_defineTag();return this});
i$(function pj_buildWith_(aPresenterClass){this.pj_presenterClass_(aPresenterClass);this.pj_build();return this});
i$(function pj_defineTag(){$asNil$($asNil$(window).pj_customElements()).pj_define_domClass_(this.tagName,this.pj_domClass());return this});
i$(function pj_domClass(){return $asNil$(window).pj_eval_(this.domClassName)});
i$(function pj_domClassName(){return this.domClassName});
i$(function pj_domClassName_(anObject){this.domClassName=anObject;return this});
i$(function pj_generateDomClass(){var jsCode,jsScript,$_self_$=this;jsCode=String.pj_streamContents_(function(str){return $_self_$.pj_writeClassJsCodeInto_(str)});jsScript=$asNil$(document).pj_createElement_("script");$asNil$(jsScript).pj_type_("text/javascript");$asNil$(jsScript).pj_innerHTML_(jsCode);$asNil$($asNil$(document).pj_body()).pj_appendChild_(jsScript);return this});
i$(function pj_innerHTML(){return this.innerHTML});
i$(function pj_innerHTML_(anObject){this.innerHTML=anObject;return this});
i$(function pj_presenterClass(){return this.presenterClass});
i$(function pj_presenterClass_(aPresenterClass){this.presenterClass=aPresenterClass;this.pj_domClassName_($asNil$(this.presenterClass).pj_domClassName());this.pj_tagName_($asNil$(this.presenterClass).pj_tagName());this.pj_innerHTML_($asNil$(this.presenterClass).pj_viewInnerHTML());return this});
i$(function pj_tagName(){return this.tagName});
i$(function pj_tagName_(anObject){this.tagName=anObject;return this});
i$(function pj_writeClassJsCodeInto_(stream){var $1;$1=$asNil$(stream);$1.pj_60_60_("class ");$1.pj_60_60_(this.domClassName);$1.pj_60_60_(" extends HTMLElement {");$1.pj_60_60_("\r\x09constructor() {\r    super();\r    const template = document.createElement(\"template\");\r    template.innerHTML = '");$1.pj_60_60_(this.innerHTML);$1.pj_60_60_("';\r    this.attachShadow({mode: \"open\"});\r    this.shadowRoot.appendChild(document.importNode(template.content, true));\r\x09 this.presenter = ");$1.pj_60_60_($asNil$(this.presenterClass).pj_name());$1.pj_60_60_(".pj_view_(this);\r  \x09}\r}");return this});
c$(function pj_buildWith_(presenterClass){$asNil$(this.pj_new()).pj_buildWith_(presenterClass);return this});
});
...
PjDomController.pj_subclass_("WcWebComponent");
WcWebComponent.$$def(function(i$,c$,cp$){
i$(function pj_initView(){return this});
i$(function pj_view(){return this.view});
i$(function pj_view_(aHTMLElement){this.view=aHTMLElement;this.shadowDomRoot=$asNil$(this.view).pj_shadowRoot();this.pj_initView();return this});
c$(function pj_buildWebComponent(){WcComponentFactory.pj_buildWith_(this);return this});
c$(function pj_domClassName(){return $asNil$(this.pj_name()).pj_44_("DOM")});
c$(function pj_javascriptInitialize(){this.pj_allSubclassesDo_(function(each){return $asNil$(each).pj_buildWebComponent()});return this});
c$(function pj_tagName(){this.pj_subclassResponsibility();return this});
c$(function pj_view_(aView){var $1;return ($1=$asNil$(this.pj_new()),$1.pj_view_(aView),$1.pj_yourself())});
c$(function pj_viewInnerHTML(){this.pj_subclassResponsibility();return this});
});
...
WcWebComponent.pj_subclass_("WcBlinkComponent");
WcBlinkComponent.$$def(function(i$,c$,cp$){
c$(function pj_tagName(){return "pj-blink"});
c$(function pj_viewInnerHTML(){return "<style> .blink { animation: 1s linear infinite condemned_blink_effect; } @keyframes condemned_blink_effect { 0% { visibility: visible; } 50% { visibility: hidden; } 100% { visibility: hidden; } } </style> <p class=\"blink\" style=\"width: inherit;\"><span><slot></slot></span></p>"});
});
